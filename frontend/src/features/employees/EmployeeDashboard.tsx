      ...
      {isMarketing ? (
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
            ...
            <div className="glass p-6 rounded-2xl flex items-center gap-4 hover:shadow-lg transition-all border border-transparent hover:border-amber-200">
              <div className="w-12 h-12 rounded-xl bg-amber-50 flex items-center justify-center text-amber-600">
                <AlertCircle className="w-6 h-6" />
              </div>
              <div>
                <span className="text-slate-400 text-xs font-bold uppercase tracking-wider">Contacted</span>
                <h3 className="text-2xl font-bold text-slate-900">{marketingContactedCount}</h3>
              </div>
            </div>
            <div className="glass p-6 rounded-2xl flex items-center gap-4 hover:shadow-lg transition-all border border-transparent hover:border-emerald-200">
              ...
              <div>
                <span className="text-slate-400 text-xs font-bold uppercase tracking-wider">Converted</span>
                <h3 className="text-2xl font-bold text-slate-900">{marketingConvertedCount}</h3>
              </div>
            </div>
          </div>

          <div className="bg-white dark:bg-slate-900/80 border border-slate-100 dark:border-slate-700 rounded-3xl p-6">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">Your Marketing Leads</h2>
            <LeadList hideHeader />
          </div>
        </>
      ) : (
